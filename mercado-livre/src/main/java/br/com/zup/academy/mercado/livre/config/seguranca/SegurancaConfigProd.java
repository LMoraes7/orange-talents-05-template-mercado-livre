...
@EnableWebSecurity
@Configuration
public class SegurancaConfigProd extends WebSecurityConfigurerAdapter {

	private AutenticacaoService autenticacaoService;
	private TokenService tokenService;
	private UsuarioRepository usuarioRepository;

	public SegurancaConfigProd(AutenticacaoService autenticacaoService, TokenService tokenService,
